...
class TFConv(Model):
  def __init__(self, constant_init):
    ...
    self.conv1 = tf.keras.layers.Conv2D(32, 3, strides=2, use_bias=True, kernel_initializer=tf.initializers.Constant(constant_init), bias_initializer=tf.initializers.Constant(constant_init))
