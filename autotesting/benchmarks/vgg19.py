...
class TFConv(Model):
    def __init__(self, **kwargs):
        ...
        self.conv_1_2 = tf.keras.layers.Conv2D(64, (3, 3), strides=(1, 1), padding='same')
        self.act1 = tf.keras.layers.ReLU()
        ...
        self.act1 = tf.keras.layers.ReLU()
        self.conv_2_2 = tf.keras.layers.Conv2D(128, (3, 3), strides=(1, 1), padding='same')
        self.act1 = tf.keras.layers.ReLU()
        ...
        self.act1 = tf.keras.layers.ReLU()
        self.conv_3_3 = tf.keras.layers.Conv2D(256, (3, 3), strides=(1, 1), padding='same')
        self.act1 = tf.keras.layers.ReLU()
        self.conv_3_4 = tf.keras.layers.Conv2D(256, (3, 3), strides=(1, 1), padding='same')
        self.act1 = tf.keras.layers.ReLU()
        ...
        self.act1 = tf.keras.layers.ReLU()
        self.conv_4_2 = tf.keras.layers.Conv2D(512, (3, 3), strides=(1, 1))
        self.act1 = tf.keras.layers.ReLU()
        self.conv_4_3 = tf.keras.layers.Conv2D(512, (3, 3), strides=(1, 1), padding='same')
        self.act1 = tf.keras.layers.ReLU()
        self.conv_4_4 = tf.keras.layers.Conv2D(512, (3, 3), strides=(1, 1), padding='same')
        self.act1 = tf.keras.layers.ReLU()
        ...
        self.act1 = tf.keras.layers.ReLU()
        self.conv_5_3 = tf.keras.layers.Conv2D(512, (3, 3), strides=(1, 1), padding='same')
        self.act1 = tf.keras.layers.ReLU()
        self.conv_5_4 = tf.keras.layers.Conv2D(512, (3, 3), strides=(1, 1), padding='same')
        self.act1 = tf.keras.layers.ReLU()
