...
class TFConv(Model):
    def __init__(self, **kwargs):
        ...
        self.pad_1 = tf.keras.layers.ZeroPadding2D(padding=3)
        self.conv = tf.keras.layers.Conv2D(64, 7, strides=2, use_bias=False)
        self.activation = tf.keras.layers.Activation('relu')
        self.pad_2 = tf.keras.layers.ZeroPadding2D(padding=1)
